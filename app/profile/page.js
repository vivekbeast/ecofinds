...
export default function ProfilePage() {
  ...
  // Fetch user info using localStorage userId
  useEffect(() => {
        ...
        <div className="w-full md:w-80 bg-white rounded-xl p-6 shadow-md flex-shrink-0">
          ...
          <div>
            ...
            <div className="space-y-2">
              <button
                onClick={() => router.push("/listings")}
                className="w-full flex items-center space-x-3 px-4 py-3 rounded-lg bg-green-50 hover:bg-green-100 text-green-700 transition-colors"
              >
                <Package className="w-5 h-5" />
                <span>My Listings</span>
              </button>
